...
class OrderRemoteDataSources @Inject constructor(
    ...
    suspend fun getPreview(body: OrderBody): BaseResponse<OrderPreviewResponse> = orderService.getPreview(body)
    suspend fun checkout(body: OrderBody): BaseMessage = orderService.checkout(body)
}