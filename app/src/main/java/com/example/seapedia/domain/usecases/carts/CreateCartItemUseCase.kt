...
class CreateCartItemUseCase @Inject constructor(
    private val cartRepository: CartRepository
) {
    suspend fun run(bodySend: CartItemBodySend): Flow<CommonState<String>>{
        return cartRepository.addCartItem(bodySend)
    }
}