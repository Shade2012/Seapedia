...
class SellerProductMapper : Mapper<BaseResponse<SellerProductsResponse>, SellerProduct>{
    override fun mapFromResponse(type: BaseResponse<SellerProductsResponse>): SellerProduct {
        val item = type.data
